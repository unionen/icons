...
import InformationOutlineMedium from './InformationOutlineMedium';
import InformationOutlineSmall from './InformationOutlineSmall';
...
export {
  ...
  InformationMedium,
  InformationOutlineMedium,
  InformationOutlineSmall,
  InformationSmall,
  LogInDoorMedium,
  LogInKeyMedium,
  LogInSmall,
